...
#By setting target = "frequent itemsets" it finds all itemsets meeting the minimum support threshold
...
```{r}
# The width of the arrow represents the support of the rule, the color the confidence
